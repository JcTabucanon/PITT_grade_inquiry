    ...
    <div class="right">
      <form method="post" action="">
        <h1>Hello, <span style="color: #6c63ff;">Good</span>&nbsp; day!</h1>
          <p class="note"></p>
           <fieldset>
            <legend>Log in Account</legend>
            
                <label class="control-label" for="inputPassword">Username</label>
                    <input type="text" id="inputEmail" name="USERNAME" placeholder="Enter Username" required>
        ...
        <div class="submit-wrapper">
          ...
          <p>Did'nt have an account? <a href="signup.php">Sign Up</a></p>
        </div>
      </form>
      <div class="bg"></div>
