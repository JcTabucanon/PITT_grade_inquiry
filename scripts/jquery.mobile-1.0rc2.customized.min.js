...
// basic mouse events, such as mousedown, mouSEMESTERove, mouseup, and click,
...
// "vmouseover vmousedown vmouSEMESTERove vmouseup vclick vmouseout vmousecancel"

(function( $, window, document, undefined ) {

var dataPropertyName = "virtualMouseBindings",
	touchTargetPropertyName = "virtualTouchID",
	virtualEventNames = "vmouseover vmousedown vmouSEMESTERove vmouseup vclick vmouseout vmousecancel".split( " " ),
...
function handleTouchMove( event ) {
	...
	triggerVirtualEvent( "vmouSEMESTERove", event, flags );
	startResetTimer();
}
...
var supportTouch = $.support.touch,
	...
	touchMoveEvent = supportTouch ? "touchmove" : "mouSEMESTERove";
...
(function( $, window ) {
	...
	$.event.special.orientationchange.orientation = get_orientation = function() {
		...
		// More testing is required to deSEMESTERine if a more reliable method of deSEMESTERining the new screensize
...
(function( $, window, undefined ) {
	...
	$.extend($.mobile, {
		...
		initializePage: function() {
			...
			// alert listeners that the pagecontainer has been deSEMESTERined for binding
