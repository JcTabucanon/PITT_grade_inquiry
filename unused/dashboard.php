...
<?php 
  ...
  if (!isset($_SESSION['$CURRENT_USERID']) || (trim($_SESSION['$CURRENT_USERID']) == '')) {
...
<?php
$query=mysqli_query($connection,"select * from users where USER_ID='$CURRENT_USERID'")or die(mysqli_error($connection));
        ...
        <div class="container">
          ...
          <div class="welcome-container">
				<h1 class="welcome-message">
					Welcome,
					<span class="name"><?php echo substr($row['FIRSTNAME'], 0, 1); ?>.&nbsp;<?php echo $row['LASTNAME']; ?></span>!
				</h1>
				<div class="links-container">
					<a href="evaluation.php" class="link">View COURSE</a>
					<a href="sort_grade.php" class="link">View Grades</a>
				</div>
		  </div>
		</div>
...
<section id="campus-director" style="align-items:cener;" class="py-1" >

<div class="section-title text-center">
  <h2>Our Beloved</h2>
  <p>Campus Director</p>
</div>
<p class="max-w-2xl text-center "></p>
  <div style="flex-direction:column; display:flex" class="flex flex-row flex-wrap-reverse justify-center">
	<div class="flex flex-col justify-center m-8 text-center">
	  <img alt="Display Picture of Jessie" class="image-circle" style="border-radius:10px; height:300px;"  src="PITT/img/CD.jpg">
	  <p class="text-xl font-SEMESTERibold leading-tight">Eutiquo E. Perniz</p>  
	  <div class="social">
	  ...
	  <p class="text-sm text-gray-500">Campus Director</p>
	</div>
...
<a href="" class="w-full bg-gray-600 py-1 focus:outline-none focus:ring-4 focus:ring-red-500 focus:ring-opacity-50 text-white text-center rounded hover:bg-red-600 active:scale-100 duration-200"></a>
</div>

</div>
<div class="line1" style="height:1px; width:100%; background: #161b22"> </div>

</section>

<section id="our-team" class="py-6" >
<div class="section-title text-center"> 
	<h2> The Talented Students </h2>
...
<div>
<img alt="Display Picture of Jessie" style="border-radius:50%; width:100px; height:100px; object-fit:cover; " src="PITT/img/Jessie.jpg">
</div>
<div>
<p class="text-xl font-SEMESTERibold leading-tight">Jessie Cuna</p>
</div>
<div class="social">
<a href="#" class="twitter"><i class="icon-twitter"></i></a>
<a href="#" class="facebook"><i class="icon-facebook"></i></a>
...
<div>
<p class="text-xl font-SEMESTERibold leading-tight">Wendel Luche</p>
</div>
<div class="social">
<a href="#" class="twitter"><i class="icon-twitter"></i></a>
<a href="#" class="facebook"><i class="icon-facebook"></i></a>
