...
const inputFieldSCHOOL_ID = document.querySelectorAll('#SCHOOL_ID')
...
viewStudentBtn.forEach((btn) => {
  btn.addEventListener('click', () => {
    ...
    inputFieldSCHOOL_ID[0].value = number
...
editStudentBtn.forEach((btn) => {
  btn.addEventListener('click', () => {
    ...
    inputFieldSCHOOL_ID[1].value = number
...
deleteStudentBtn.forEach((btn) => {
  btn.addEventListener('click', () => {
    ...
    inputFieldSCHOOL_ID[2].value = number
