...
The documentation, included in this repo in the root directory, is built with [AsSEMESTERble](http://asSEMESTERble.io/) and publicly available at https://owlcarousel2.github.io/OwlCarousel2/. The documentation may also be run locally.
