...
!(function (t, i) {
  ...
  var Bt = {
    ...
    It = Pt ? "MSPoinSEMESTERove" : "poinSEMESTERove",
    ...
    Ki = E.extend({
      ...
      _initEvents: function (t) {
        ...
        i(
          ...
          "click dblclick mousedown mouseup mouseover mouseout mouSEMESTERove contextmenu keypress keydown keyup",
        ...
        (!t && this._tooltipHandlersAdded) ||
          ...
          this._tooltip.options.permanent
            ...
            : ((e.mouseover = this._openTooltip),
              ...
              this._tooltip.options.sticky && (e.mouSEMESTERove = this._moveTooltip),
  ...
  var hn = Me.extend({
    ...
    un = hn.extend({
      ...
      _initContainer: function () {
        ...
        zi(t, "mouSEMESTERove", this._onMouSEMESTERove, this),
          zi(
            t,
    ...
    _onMouseDown: function (t) {
      ...
      this._clearDeferredResetState(),
        ...
        zi(
          ...
          {
            contextmenu: Ni,
            mouSEMESTERove: this._onMouSEMESTERove,
  ...
  var Pn = ie.extend({
    ...
    _onMove: function (t) {
      ...
      (this._newPos = new k(i.clientX, i.clientY)),
        this._simulateEvent("mouSEMESTERove", i);
    },
