...
(function() {
  ...
  AbstractChosen = (function() {
    ...
    AbstractChosen.prototype.get_no_results_html = function(SEMESTERs) {
      return "<li class=\"no-results\">\n  " + this.results_none_found + " <span>" + (this.escape_html(SEMESTERs)) + "</span>\n</li>";
    };
  ...
  this.Chosen = (function(superClass) {
    ...
    Chosen.prototype.no_results = function(SEMESTERs) {
      this.search_results.insert(this.get_no_results_html(SEMESTERs));
