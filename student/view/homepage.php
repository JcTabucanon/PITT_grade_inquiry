      ...
      <section>
        <div class="container flex flex-col justify-center p-12 mx-auto lg:flex-row lg:justify-between">
          ...
          <div class="flex flex-col justify-center p-6 text-center rounded-sm lg:max-w-md xl:max-w-lg lg:text-left">
            <h1 class="mb-8 text-5xl text-white font-bold leading-none sm:text-6xl">Welcome,
              <span class="text-violet-400"><?php echo substr($row['FIRSTNAME'], 0, 1); ?>.&nbsp;<?php echo $row['LASTNAME']; ?></span>!
            </h1>
            <div class="flex flex-col space-y-4 sm:items-center sm:justify-center sm:flex-row sm:space-y-0 sm:space-x-4 lg:justify-start">
              <a href="courses.php" class="px-8 py-3 text-lg font-semibold text-gray-700 duration-150 bg-indigo-100 rounded shadow-md shadow-indigo-700/10 hover:text-white hover:bg-indigo-500">Grade Sheet</a>
            ...
            <!-- <button><a href="index.php"></i>&nbsp;Confirm</button> -->
