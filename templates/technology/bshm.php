<div class="technology">
     ...
     <div class="card-con">
          <div class="card-box">
               <div class="card">
                    <a href="viewcurriculum.php?SEMESTER=1st&AY=<?php echo $current_year;
?>&COURSE=BSHM&YLEVEL=1">
                    <div class="card-1">
...
?>&COURSE=BSHM&YLEVEL=4">
     ...
     <div class="COURSE-info">
          <p>Info : This is the end of COURSE menu.</p>
     </div>
