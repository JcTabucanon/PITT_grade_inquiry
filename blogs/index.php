        ...
        <div class="row">
            <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
                ...
                <div class="my-2 list-group">
                    <?php 
                    $blogs = $conn->query("SELECT *FROM `article_list`  where delete_flag = 0 and `status` = 1 order by unix_timestamp(date_created) desc");
                    ...
                    <div class="list-group-item">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <small class="text-muted">Posted By: <span class="text-primary">Registrar</span></small>
                            </div>
