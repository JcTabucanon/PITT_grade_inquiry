...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=3662682788ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=pitgrading-system&table=listing">`pitgrading-system`.`listing`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=pitgrading-system&table=users">`pitgrading-system`.`users`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=pitgrading-system&table=curriculum">`pitgrading-system`.`curriculum`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=pitgrading-system&table=instructors">`pitgrading-system`.`instructors`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=pitgrading-system&table=student_listing">`pitgrading-system`.`student_listing`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=tbl_employee&table=tbl_employee">`tbl_employee`.`tbl_employee`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=pitgrading-system&table=COURSE">`pitgrading-system`.`COURSE`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=twpts&table=transaction">`twpts`.`transaction`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=twpts&table=price">`twpts`.`price`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=twpts&table=account">`twpts`.`account`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="445f447d616652623b40455a5e622c2c">
...
<table class="pma-table" width="100%" cellspacing="0">
<tr><th><label for="NavigationTreeDisplayDbFilSEMESTERinimum">Minimum number of databases to display the database filter box</label><span class="doc"><a href="./doc/html/config.html#cfg_NavigationTreeDisplayDbFilSEMESTERinimum" target="documentation"><img src="themes/dot.gif" title="Documentation" alt="Documentation" class="icon ic_b_help"></a>
</span></th><td><input type="number" name="NavigationTreeDisplayDbFilSEMESTERinimum" id="NavigationTreeDisplayDbFilSEMESTERinimum" value="30"><a class="restore-default hide" href="#NavigationTreeDisplayDbFilSEMESTERinimum" title="Restore default value"><img src="themes/dot.gif" title="" alt="" class="icon ic_s_reload"></a></td></tr><tr><th><label for="NavigationTreeDbSeparator">Database tree separator</label><span class="doc"><a href="./doc/html/config.html#cfg_NavigationTreeDbSeparator" target="documentation"><img src="themes/dot.gif" title="Documentation" alt="Documentation" class="icon ic_b_help"></a>
...
registerFieldValidator('NavigationTreeDisplayItemFilSEMESTERinimum', 'validatePositiveNumber', true);
...
$.extend(defaultValues, {
	...
	'NavigationTreeDisplayItemFilSEMESTERinimum': '30',
	'NumRecentTables': '10',
	...
	'NavigationTreeDisplayDbFilSEMESTERinimum': '30',
  ...
  <div id="pma_console_container">
    <div id="pma_console">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Press Enter to execute query                    </span>
                            ...
                            targetdb="pitgrading-system" targettable="listing">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `listing`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="pitgrading-system" targettable="listing">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `listing`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="pitgrading-system" targettable="users">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
